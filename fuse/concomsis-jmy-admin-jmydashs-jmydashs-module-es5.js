...
var JmydashsComponent = /** @class */ (function () {
    /**
     * Constructor
     *
     ...
     */
    function JmydashsComponent(_fuseSidebarService, _JmydashsService) {
        var _this = this;
     ...
     * On init
     */
    JmydashsComponent.prototype.ngOnInit = function () {
     ...
     * @param name
     */
    JmydashsComponent.prototype.toggleSidebar = function (name) {
...
var JmydashsModule = /** @class */ (function () {
    function JmydashsModule() {
    }
...
var JmydashsService = /** @class */ (function () {
    /**
     * Constructor
     *
     * @param {HttpClient} _httpClient
     */
    function JmydashsService(_httpClient, jmyS) {
     ...
     */
    JmydashsService.prototype.resolve = function (route, state) {
        var _this = this;
     ...
     * @returns {Promise<any>}
     */
    JmydashsService.prototype.getProjects = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
     ...
     * @returns {Promise<any>}
     */
    JmydashsService.prototype.getWidgets = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
...
//# sourceMappingURL=concomsis-jmy-admin-jmydashs-jmydashs-module-es5.js.map