...
class NestedTreeControl extends BaseTreeControl {
    ...
    _getDescendants(descendants, dataNode) {
        ...
        if (Array.isArray(childrenNodes)) {
            ...
            childrenNodes.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["filter"])(Boolean)).subscribe((/**
             * @param {?} children
             * @return {?}
             */
            children => {
...
let SCProvedoresService = class SCProvedoresService {
    ...
    constructor(_httpClient, jmyService) {
        ...
        this.jmyService.jmyPerfil.perfilChange.subscribe(perfil => {
            this.baseDB = (perfil.eid != undefined) ? '/sc/' + perfil.eid + '/proveedores' : '';
