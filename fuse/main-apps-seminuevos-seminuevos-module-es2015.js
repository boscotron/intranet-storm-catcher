...
let SeminuevosModule = class SeminuevosModule {
};
...
let SeminuevosUnidadComponent = 
/**
 * @title Basic select
 */
class SeminuevosUnidadComponent {
    /**
     * Constructor
     *
    ...
    ngOnInit() {
        ...
        this._ecommerceProductService.onProductChanged
            ...
            .subscribe(product => {
            if (product) {
                this.product = new app_main_apps_seminuevos_unidad_unidad_model__WEBPACK_IMPORTED_MODULE_9__["Product"](product);
                this.pageType = 'edit';
            }
            else {
                this.pageType = 'new';
    ...
    saveProduct() {
        ...
        this._ecommerceProductService.saveProduct(data)
            ...
            this._matSnackBar.open('Guardado', 'OK', {
    ...
    addProduct() {
        ...
        this._ecommerceProductService.addProduct(data)
            ...
            this._location.go('seminuevos/unidades/' + this.product.id + '/' + this.product.handle);
        });
    }
};
...
let SeminuevosUnidadService = class SeminuevosUnidadService {
    /**
     * Constructor
     *
    ...
    getProduct() {
        return new Promise((resolve, reject) => {
            if (this.routeParams.id === 'new') {
                ...
                this.jmyService.dbRealTime.object('seminuevos/unidades/' + this.routeParams.id).valueChanges().subscribe(resultado => {
    ...
    saveProduct(product) {
        return new Promise((resolve, reject) => {
            this.jmyService.dbRealTime.object('seminuevos/unidades/' + product.id).set(product).then(resultado => {
                const not = {
...
let SeminuevosUnidadesComponent = class SeminuevosUnidadesComponent {
...
class FilesDataSource extends _angular_cdk_collections__WEBPACK_IMPORTED_MODULE_4__["DataSource"] {
    /**
     * Constructor
     *
    ...
    constructor(_ecommerceProductsService, _matPaginator, _matSort) {
        ...
        this._filteredDataChange = new rxjs__WEBPACK_IMPORTED_MODULE_5__["BehaviorSubject"]('');
    ...
    connect() {
        ...
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["merge"])(...displayDataChanges)
        ...
        return data.sort((a, b) => {
            ...
            switch (this._matSort.active) {
                /* case 'id':
                    ...
                    break; */
                case 'inventario':
                    [propertyA, propertyB] = [a.inventario, b.inventario];
                    break;
                case 'statu':
                    [propertyA, propertyB] = [a.status[0], b.status[0]];
                    break;
                case 'marca':
...
let SeminuevosUnidadesService = class SeminuevosUnidadesService {
    /**
     * Constructor
     *
     * @param {HttpClient} _httpClient
    ...
    getProducts() {
        return new Promise((resolve, reject) => {
            this.jmyService.dbRealTime.list('seminuevos/unidades/').valueChanges().subscribe(respuesta => {
...
//# sourceMappingURL=main-apps-seminuevos-seminuevos-module-es2015.js.map